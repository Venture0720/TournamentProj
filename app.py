...
PATCHED: Error handling, memory management, and temperature-based physics.
"""
...
def make_hydraulic_plot(df: pd.DataFrame, 
    ...
    fig.update_layout(
        ...
        legend=dict(bgcolor="rgba(0,0,0,0)", bordercolor=grid_c, borderwidth=1, orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1)
    )
...
def main():
    ...
    # Main dashboard continues from here...
