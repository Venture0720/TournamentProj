...
class BrandColors:
    ...
    PRIMARY_COLOR: str = "#1D4ED8"      # Deep Blue - Trust & Reliability
    SECONDARY_COLOR: str = "#0EA5E9"    # Azure - Water & Technology
    SUCCESS_COLOR: str = "#22C55E"      # Green - Operational Excellence
    WARNING_COLOR: str = "#F59E0B"      # Amber - Attention Required
    DANGER_COLOR: str = "#EF4444"       # Red - Critical Alert
    INFO_COLOR: str = "#38BDF8"         # Sky - Information
    BACKGROUND_DARK: str = "#0B1120"    # Deep Navy - Dark Mode
    BACKGROUND_LIGHT: str = "#F8FAFC"   # Light Slate - Light Mode
    TEXT_PRIMARY: str = "#E2E8F0"       # Light text for dark UI
    TEXT_SECONDARY: str = "#94A3B8"     # Muted light text
    BORDER_COLOR: str = "#1E293B"       # Subtle dark border
    
    # Gradient Definitions
    GRADIENT_PRIMARY: str = "linear-gradient(135deg, #1D4ED8 0%, #0EA5E9 100%)"
    GRADIENT_SUCCESS: str = "linear-gradient(135deg, #22C55E 0%, #86EFAC 100%)"
    GRADIENT_DANGER: str = "linear-gradient(135deg, #EF4444 0%, #FB7185 100%)"
...
class AppMetadata:
    ...
    APP_TAGLINE: str = "Digital Twin Mission Control for Kazakhstan's Water Networks"
    VERSION: str = "1.1.0"
...
class VisualizationConfig:
    ...
    PRESSURE_COLORSCALE: List[List] = field(default_factory=lambda: [
        ...
        [1.0, "#22C55E"]     # High pressure - Green
    ])
    ...
    LARGE_CHART_HEIGHT: int = 620
    SMALL_CHART_HEIGHT: int = 320
